  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-green-500 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-[#333] text-gray-200 shadow-sm hover:bg-[#444]",
        ghost:
          "text-gray-300 hover:bg-[#333] hover:text-gray-100",
        destructive:
          "bg-red-700 text-white shadow-sm hover:bg-red-800",
        outline:
          "border border-[#555] bg-transparent text-gray-200 shadow-sm hover:bg-[#333]",
        link:
